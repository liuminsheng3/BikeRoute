...
public class CloudLogicAPIFactory {
    ...
    public static CloudLogicAPIConfiguration[] getAPIs() {
        final CloudLogicAPIConfiguration[] apis = new CloudLogicAPIConfiguration[] {
                new CloudLogicAPIConfiguration("BikeRoute",
                                              "",
                                              "https://8j5qvj5r28.execute-api.us-east-1.amazonaws.com/Development",
                                              new String[] {
                                                  "/items",
                                                  "/items/123",
                                              },
                                              com.amazonaws.mobile.api.id8j5qvj5r28.BikeRouteMobileHubClient.class),
        };
